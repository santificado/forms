function submitQuiz() {
    ...
    const correctAnswers = {
        ...
        q2: "Lesão reversível, é uma lesão leve e transitória, enquanto a irreversível leva a morte celular, ou apoptose ou necrose.",
    ...
    // Destacar as respostas corretas e incorretas
    for (let key in correctAnswers) {
